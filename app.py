...
bot = commands.Bot(command_prefix=get_prefix, description='A bot for shop 67HS. Prefix your commands with / or ?',intents=intents)
...
async def on_ready():
    ...
    await bot.change_presence(activity=discord.Activity(type=discord.ActivityType.watching, name="/help and ?help"))
